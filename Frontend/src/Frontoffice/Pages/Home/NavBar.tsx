...
export const navLinks = [
  ...
  },
  {
    id: "about",
    title: "About",
    link: "/second-app/about",
  },
  {
    id: "Products",
    title: "Products",
    link: "/second-app/products",
  },
            ...
            >
              <div className="card-body">
                ...
                <div className="card-actions">
                 <a href="/second-app/shoppingcart"> <button className="btn btn-outline btn-block hover:bg-customColor font-primary" >
                    View cart
                  </button></a>
                </div>
              </div>
