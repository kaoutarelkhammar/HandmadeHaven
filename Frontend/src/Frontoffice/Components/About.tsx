  ...
  return (
    <>
      ...
      <div>
        ...
        <div className="hero-content text-center text-neutral-content h-[25rem] bg-backgroundColor">
          <div className="max-w-[40rem]">
            ...
            <a href="/second-app/products"><button className="btn btn-outline border h-9 w-[10rem] font-primary text-yellow-900 rounded-md hover:bg-customColor"> Discover our crafts</button></a>
          </div>
        </div>
      </div>
      <Footer />
